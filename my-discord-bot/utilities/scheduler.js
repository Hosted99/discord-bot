...
async function handleManiaPlan(msg) {
    ...
    const MAIN_CHANNEL_ID = '1486343047632523398'; ///////////////////////трябва да върна кода после 1486343047632523398
 
    // Конфигурация на ролите за двете гилдии
    const ROLES = {
        'g1': '1490805399010545794',   ///////////////////////трябва да върна кода после 1490805399010545794
        'g2': '1490805404710469642'   ///////////////////////трябва да върна кода после  1490805404710469642
    };
